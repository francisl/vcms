...
urlpatterns = patterns('vcms.apps.simplenews.views',
    (r'^news/(?P<category_slug>\w+)/page-(?P<page>)/$', 'news_index'), # /news/finances/page-1/
    ...
    (r'^news/(?P<category_slug>\w+)/category/(?P<category>\w)/page-(?P<page>)/$', 'news_category'), # /news/finances/category/Technology/page-1/
    ...
    (r'^news/(?P<category_slug>\w+)/archives/(?P<month>\d{2})-(?P<year>\d{4})/page-(?P<page>)/$', 'news_archives'), # /news/finances/archives/12-2010/page-1/
