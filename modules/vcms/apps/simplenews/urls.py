...
urlpatterns = patterns('vcms.apps.simplenews.views',
    (r'^simplenews/(?P<category_slug>.+)/page-(?P<page>\d+)/$', 'news_index'), # /news/finances/page-1/
    url(r'^simplenews/page-(?P<page>\d+)/$', 'news_index', { "category_slug": None }), # /news/page-1/
    (r'^simplenews/(?P<category_slug>.+)/(?P<news_slug>.+)/$', 'news_unique'), # /news/finances/year-of-the-linux-desktop/
    ...
    (r'^simplenews/(?P<category_slug>.+)/', 'news_index'), # Catchall index page for a category
    url(r'^simplenews/', 'news_index', { "category_slug": None }), # Catchall index page
)
